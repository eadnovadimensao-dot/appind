        ...
        $db->prepare("
            INSERT INTO services
              (church_id, title, type, service_date, time_start, time_end,
               supervisor_id, notes, status, created_by)
            VALUES (?,?,?,?,?,?,?,?,'planning',?)
        ")->execute([$churchId,$title,$type,$date,$timeStart,$timeEnd,
                     $supervisorId,$notes?:null,
                     auth_member_id()]);
...
<form method="POST" style="width:100%">
  ...
  <!-- Supervisor -->
  <div class="card" style="margin-bottom:16px">
    <p class="card-title">Responsável</p>
    <div class="form-row">
      <div class="form-group">
    ...
    <p style="font-size:12px;color:var(--text-muted);margin-top:4px">
      🎤 Pregador, tema e referências bíblicas são preenchidos depois, em Programação.
    </p>
  </div>
